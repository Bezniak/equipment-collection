...
import MetaTags from "../../common/MetaTags.jsx"; // Подключение мета-тегов
...
const Slider = () => {
    ...
    return (
        <>
            <MetaTags page="meta.home" /> {/* Добавьте мета-теги для главной страницы */}
                ...
                >
                    {sliderData.map((slide, index) => (
                        <SwiperSlide key={index} className="relative w-full h-full object-cover">
                            ...
                            <img src={slide.image} alt={t(slide.titleKey)} className="w-full h-full object-cover" />
                            <div
