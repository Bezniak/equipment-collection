...
import {FaBolt, FaClock, FaHandHoldingUsd, FaMoneyBillWave, FaRecycle, FaTruck} from "react-icons/fa";
...
const Advantages = () => {
    ...
    const advantages = [
        ...
        {icon: FaMoneyBillWave, title: "advantageTitle_3", desc: "advantageDesc_3", color: "text-blue-400"},
