...
export default function ContactInfo() {
    ...
    return (
        ...
        >
            <div
                className="bg-black opacity-90 py-16 text-white p-6 flex flex-col md:flex-row justify-evenly items-center text-center md:text-left">
